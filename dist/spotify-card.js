 ...
 */}const e="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,i=(t,e,i=null)=>{for(;e!==i;){const i=e.nextSibling;t.removeChild(e),e=i}},s=`{{lit-${String(Math.random()).slice(2)}}}`,n=`\x3c!--${s}--\x3e`,r=new RegExp(`${s}|${n}`);class o{constructor(t,e){this.parts=[],this.element=e;const i=[],n=[],o=document.createTreeWalker(e.content,133,null,!1);let c=0,h=-1,p=0;const{strings:u,values:{length:g}}=t;for(;p<g;){const t=o.nextNode();if(null!==t){if(h++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:i}=e;let s=0;for(let t=0;t<i;t++)a(e[t].name,"$lit$")&&s++;for(;s-- >0;){const e=u[p],i=d.exec(e)[2],s=i.toLowerCase()+"$lit$",n=t.getAttribute(s);t.removeAttribute(s);const o=n.split(r);this.parts.push({type:"attribute",index:h,name:i,strings:o}),p+=o.length-1}}"TEMPLATE"===t.tagName&&(n.push(t),o.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(s)>=0){const s=t.parentNode,n=e.split(r),o=n.length-1;for(let e=0;e<o;e++){let i,r=n[e];if(""===r)i=l();else{const t=d.exec(r);null!==t&&a(t[2],"$lit$")&&(r=r.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),i=document.createTextNode(r)}s.insertBefore(i,t),this.parts.push({type:"node",index:++h})}""===n[o]?(s.insertBefore(l(),t),i.push(t)):t.data=n[o],p+=o}}else if(8===t.nodeType)if(t.data===s){const e=t.parentNode;null!==t.previousSibling&&h!==c||(h++,e.insertBefore(l(),t)),c=h,this.parts.push({type:"node",index:h}),null===t.nextSibling?t.data="":(i.push(t),h--),p++}else{let e=-1;for(;-1!==(e=t.data.indexOf(s,e+1));)this.parts.push({type:"node",index:-1}),p++}}else o.currentNode=n.pop()}for(const t of i)t.parentNode.removeChild(t)}}const a=(t,e)=>{const i=t.length-e.length;return i>=0&&t.slice(i)===e},c=t=>-1!==t.index,l=()=>document.createComment(""),d=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function h(t,e){const{element:{content:i},parts:s}=t,n=document.createTreeWalker(i,133,null,!1);let r=u(s),o=s[r],a=-1,c=0;const l=[];let d=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(l.push(t),null===d&&(d=t)),null!==d&&c++;void 0!==o&&o.index===a;)o.index=null!==d?-1:o.index-c,r=u(s,r),o=s[r]}l.forEach(t=>t.parentNode.removeChild(t))}const p=t=>{let e=11===t.nodeType?0:1;const i=document.createTreeWalker(t,133,null,!1);for(;i.nextNode();)e++;return e},u=(t,e=-1)=>{for(let i=e+1;i<t.length;i++){const e=t[i];if(c(e))return i}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,s){const n=e[0];if("."===n){return new k(t,e.slice(1),i).parts}if("@"===n)return[new M(t,e.slice(1),s.eventContext)];if("?"===n)return[new $(t,e.slice(1),i)];return new x(t,e,i).parts}handleTextExpression(t){return new P(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const A=(t,...e)=>new w(t,e,"html",z)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const et={};class it extends I{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,i)=>t.reduceRight((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t),i),i=e(t,new Set),s=[];i.forEach(t=>s.unshift(t)),this._styles=s}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?K?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==et&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return et}}it.finalized=!0,it.render=(t,e,s)=>{if(!s||"object"!=typeof s||!s.scopeName)throw new Error("The `scopeName` option is required.");const n=s.scopeName,r=E.has(e),o=j&&11===e.nodeType&&!!e.host,a=o&&!R.has(n),c=a?document.createDocumentFragment():e;if(((t,e,s)=>{let n=E.get(e);void 0===n&&(i(e,e.firstChild),E.set(e,n=new P(Object.assign({templateFactory:V},s))),n.appendInto(e)),n.setValue(t),n.commit()})(t,c,Object.assign({templateFactory:H(n)},s)),a){const t=E.get(c);E.delete(c);const s=t.value instanceof y?t.value.template:void 0;q(n,c,s),i(e,e.firstChild),e.appendChild(c),E.set(e,t)}!r&&o&&window.ShadyCSS.styleElement(e.host)};var st=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,nt="[^\\s]+",rt=/\[([^]*?)\]/gm;function ot(t,e){for(var i=[],s=0,n=t.length;s<n;s++)i.push(t[s].substr(0,e));return i}var at=function(t){return function(e,i){var s=i[t].map((function(t){return t.toLowerCase()})).indexOf(e.toLowerCase());return s>-1?s:null}};function ct(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i];for(var s=0,n=e;s<n.length;s++){var r=n[s];for(var o in r)t[o]=r[o]}return t}var lt=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],dt=["January","February","March","April","May","June","July","August","September","October","November","December"],ht=ot(dt,3),pt={dayNamesShort:ot(lt,3),dayNames:lt,monthNamesShort:ht,monthNames:dt,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10?1:0)*t%10]}},ut=ct({},pt),gt=function(t,e){for(void 0===e&&(e=2),t=String(t);t.length<e;)t="0"+t;return t},_t={D:function(t){return String(t.getDate())},DD:function(t){return gt(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return String(t.getDay())},dd:function(t){return gt(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return String(t.getMonth()+1)},MM:function(t){return gt(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return gt(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return gt(t.getFullYear(),4)},h:function(t){return String(t.getHours()%12||12)},hh:function(t){return gt(t.getHours()%12||12)},H:function(t){return String(t.getHours())},HH:function(t){return gt(t.getHours())},m:function(t){return String(t.getMinutes())},mm:function(t){return gt(t.getMinutes())},s:function(t){return String(t.getSeconds())},ss:function(t){return gt(t.getSeconds())},S:function(t){return String(Math.round(t.getMilliseconds()/100))},SS:function(t){return gt(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return gt(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+gt(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)},Z:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+gt(Math.floor(Math.abs(e)/60),2)+":"+gt(Math.abs(e)%60,2)}},mt=function(t){return+t-1},ft=[null,"[1-9]\\d?"],yt=[null,nt],vt=["isPm",nt,function(t,e){var i=t.toLowerCase();return i===e.amPm[0]?0:i===e.amPm[1]?1:null}],wt=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(t){var e=(t+"").match(/([+-]|\d\d)/gi);if(e){var i=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?i:-i}return 0}],bt=(at("monthNamesShort"),at("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var St=function(t,e,i){if(void 0===e&&(e=bt.default),void 0===i&&(i={}),"number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date pass to format");var s=[];e=(e=bt[e]||e).replace(rt,(function(t,e){return s.push(e),"@@@"}));var n=ct(ct({},ut),i);return(e=e.replace(st,(function(e){return _t[e](t,n)}))).replace(/@@@/g,(function(){return s.shift()}))};(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}})(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}();const xt=t=>{let e=[];function i(i,s){t=s?i:Object.assign(Object.assign({},t),i);let n=e;for(let e=0;e<n.length;e++)n[e](t)}return{get state(){return t},action(e){function s(t){i(t,!1)}return function(){let i=[t];for(let t=0;t<arguments.length;t++)i.push(arguments[t]);let n=e.apply(this,i);if(null!=n)return n instanceof Promise?n.then(s):s(n)}},setState:i,subscribe:t=>(e.push(t),()=>{!function(t){let i=[];for(let s=0;s<e.length;s++)e[s]===t?t=null:i.push(e[s]);e=i}(t)})}},Ct=(t,e,i,s)=>{if(t[e])return t[e];let n,r=0,o=xt();const a=()=>i(t).then(t=>o.setState(t,!0)),c=()=>a().catch(e=>{if(t.connected)throw e});return t[e]={get state(){return o.state},refresh:a,subscribe(e){r++,1===r&&(s&&(n=s(t,o)),t.addEventListener("ready",c),c());const i=o.subscribe(e);return void 0!==o.state&&setTimeout(()=>e(o.state),0),()=>{i(),r--,r||(n&&n.then(t=>{t()}),t.removeEventListener("ready",a))}}},t[e]},Pt=t=>t.sendMessagePromise({type:"get_states"});function $t(t,e){if(void 0===t)return null;const{domain:i,service:s}=e.data;return{[i]:Object.assign({},t[i],{[s]:{description:"",fields:{}}})}}function kt(t,e){if(void 0===t)return null;const{domain:i,service:s}=e.data,n=t[i];if(!n||!(s in n))return null;const r={};return Object.keys(n).forEach(t=>{t!==s&&(r[t]=n[t])}),{[i]:r}}const Nt=t=>t.sendMessagePromise({type:"get_services"}),Tt=(t,e)=>Promise.all([t.subscribeEvents(e.action($t),"service_registered"),t.subscribeEvents(e.action(kt),"service_removed")]).then(t=>()=>t.forEach(t=>t()));async function Mt(t){const e=await Pt(t),i={};for(let t=0;t<e.length;t++){const s=e[t];i[s.entity_id]=s}return i}const Ot=(t,e)=>t.subscribeEvents(t=>function(t,e){const i=t.state;if(void 0===i)return;const{entity_id:s,new_state:n}=e.data;if(n)t.setState({[n.entity_id]:n});else{const e=Object.assign({},i);delete e[s],t.setState(e,!0)}}(e,t),"state_changed"),Vt=(t,e)=>(t=>Ct(t,"_ent",Mt,Ot))(t).subscribe(e);var Dt={version:"Version",description:"A custom card for displaying Spotify-Playlist and starting playback",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_missing_spotcast:"Spotcast integration has to be installed for this component to work",show_missing_spotify:"Spotify integration has to be installed for playback information",choose_player:"Choose player"},Et={general:"General",general_description:"General settings for this card",appearance:"Appearance",appearance_description:"Customize the style, icon, etc",hide_warning:"Hide warnings",playlist_type:"Playlist Type",limit:"Amount of playlists shown",height:"Height of card",country_code:"Country Code for featured playlists",always_play_random_song:"Always play random song when starting playback",title:"Title of card",display_style:"Display Style",grid_cover_size:"Cover size in Grid-View in pixels",grid_center_covers:"Center the covers in Grid-View"},zt={common:Dt,settings:Et},At={version:"Version",description:"Eine Karte um Spotify-Playlist anzuzeigen und abzuspielen",invalid_configuration:"Ungültige Konfiguration",show_warning:"Warnung",show_missing_spotcast:"Die Spotcast-Integration muss installiert sein, damit diese Karte funktioniert",show_missing_spotify:"Die Spotify-Integration muss installiert sein, damit der Spotify-Status angezeigt werden kann"},Ut={general:"Generell",general_description:"Generelle Einstellungen",appearance:"Aussehen",appearance_description:"Passe den Stil und anderes an",hide_warning:"Verstecke Warnhinweise",playlist_type:"Playlist Typ",limit:"Anzahl an angezeigten Playlisten",height:"Höhe der Karte",country_code:"Länder-Code für die Featured-Playlist",always_play_random_song:"Spiele immer einen zufälligen Song beim Starten der Wiedergabe ab",title:"Titel der Karte",display_style:"Anzeige-Stil",grid_cover_size:"Cover Größe in der Karten-Ansicht in Pixeln",grid_center_covers:"Zentriere die Cover in der Karten-Ansicht"},jt={common:At,settings:Ut},Ht={version:"Version",description:"A custom card for displaying Spotify-Playlist and starting playback",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_missing_spotcast:"Spotcast integration has to be installed for this component to work",show_missing_spotify:"Spotify integration has to be installed for playback information"},Yt={general:"General",general_description:"General settings for this card",appearance:"Appearance",appearance_description:"Customize the style, icon, etc",hide_warning:"Hide warnings",playlist_type:"Playlist Type",limit:"Amount of playlists shown",height:"Height of card",country_code:"Country Code for featured playlists",always_play_random_song:"Always play random song when starting playback",title:"Title of card",display_style:"Display Style",grid_cover_size:"Cover size in Grid-View in pixels",grid_center_covers:"Center the covers in Grid-View"},Rt={common:Ht,settings:Yt};const qt={en:Object.freeze({__proto__:null,common:Dt,settings:Et,default:zt}),de:Object.freeze({__proto__:null,common:At,settings:Ut,default:jt}),se:Object.freeze({__proto__:null,common:Ht,settings:Yt,default:Rt})};function Lt(t,e="",i=""){const s=t.split(".")[0],n=t.split(".")[1],r=(localStorage.getItem("selectedLanguage")||navigator.language.split("-")[0]||"en").replace(/['"]+/g,"").replace("-","_");let o;try{o=qt[r][s][n]}catch(t){o=qt.en[s][n]}return void 0===o&&(o=qt.en[s][n]),""!==e&&""!==i&&(o=o.replace(e,i)),o}const Wt={general:{icon:"tune",name:Lt("settings.general"),secondary:Lt("settings.general_description"),show:!0},appearance:{icon:"palette",name:Lt("settings.appearance"),secondary:Lt("settings.appearance_description"),show:!1}},Ft=["Default","featured","discover-weekly"],It=["List","Grid"];let Gt=class extends it{setConfig(t){this._config=t}get _name(){return this._config&&this._config.name||""}get _country_code(){return this._config&&this._config.country_code||""}get _limit(){return this._config&&this._config.limit||10}get _playlist_type(){return this._config?this._config.playlist_type||"Default":""}get _always_play_random_song(){return this._config&&this._config.always_play_random_song||!1}get _height(){return this._config&&this._config.height||""}get _display_style(){return this._config&&this._config.display_style||"List"}get _grid_cover_size(){return this._config&&this._config.grid_cover_size||100}get _grid_center_covers(){return this._config&&this._config.grid_center_covers||!1}get _hide_warning(){return this._config&&this._config.hide_warning||!1}get _show_warning(){return this._config&&this._config.show_warning||!1}get _show_error(){return this._config&&this._config.show_error||!1}render(){return this.hass?A`
              ...
              <div class="values">
                ...
                <div>
                  <ha-switch
                    ...
                    >${Lt("settings.always_play_random_song")}</ha-switch
                  >
                </div>
              </div>
            `:""}
              ...
              <div class="values">
                ...
                <div>
                  <ha-switch
                    ...
                    @change=${this._valueChanged}
                    >${Lt("settings.grid_center_covers")}</ha-switch
                  >
                </div>
                <ha-switch
    ...
    `}};t([J({type:Object})],Gt.prototype,"hass",void 0),t([Z()],Gt.prototype,"_config",void 0),t([Z()],Gt.prototype,"_toggle",void 0),Gt=t([G("spotify-card-editor")],Gt);class Bt{constructor(t){this.playlists={},this.devices=[],this.players=[],this.chromecast_devices=[],this.loading=!1,this.parent=t}is_loading(){return setTimeout(this.set_loading_off,100),this.loading}set_loading_off(){this.loading=!1}is_loaded(){return void 0!==this.playlists.length}getPlaybackOptions(t){const e={uri:t,force_playback:"playing"==this.parent.getSpotifyEntityState(),random_song:this.parent.config.always_play_random_song};return this.parent.config.account&&(e.account=this.parent.config.account),e}playUri(t){const e=this.getCurrentPlayer();e?this.playUriOnConnectDevice(e.id,t):console.error("No active device")}transferPlaybackToCastDevice(t){this.parent.hass.callService("spotcast","start",{device_name:t,force_playback:!0})}transferPlaybackToConnectDevice(t){this.parent.hass.callService("spotcast","start",{spotify_device_id:t,force_playback:!0})}playUriOnCastDevice(t,e){const i=Object.assign(Object.assign({},this.getPlaybackOptions(e)),{device_name:t});this.parent.hass.callService("spotcast","start",i)}playUriOnConnectDevice(t,e){const i=Object.assign(Object.assign({},this.getPlaybackOptions(e)),{spotify_device_id:t});this.parent.hass.callService("spotcast","start",i)}async updateState(){await this.fetchDevices(),await this.fetchPlayer(),await this.fetchChromecasts()}getCurrentPlayer(){const t=this.players.filter(t=>t.is_active).find(t=>null!=t);return t||null}async fetchPlayer(){const t=await this.parent.hass.callWS({type:"spotcast/player",account:"default"});this.players=t.devices}async fetchDevices(){const t=await this.parent.hass.callWS({type:"spotcast/devices",account:"default"});this.devices=t.devices}async fetchChromecasts(){const t=await this.parent.hass.callWS({type:"config/entity_registry/list"});this.chromecast_devices=t.filter(t=>"cast"==t.platform).map(t=>this.parent.hass.states[t.entity_id]).filter(t=>null!=t&&"unavailable"!=t.state)}fetchPlaylists(t){console.log(t),this.loading=!0;const e={type:"spotcast/playlists",playlist_type:this.parent.config.playlist_type?this.parent.config.playlist_type:""};this.parent.config.country_code&&(e.country_code=this.parent.config.country_code),this.parent.hass.connection.sendMessagePromise(e).then(t=>{this.playlists=t.items,this.parent.requestUpdate()},t=>{console.error("fetchPlaylists failed!",t)})}}var Jt;console.info(`%c  SPOTIFY-CARD \n%c  ${Lt("common.version")} 2.0.0    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"spotify-card",name:"Spotify Card",description:Lt("common.description"),preview:!0});let Zt=Jt=class extends it{constructor(){super(...arguments),this.spotcast_installed=!1,this.spotify_installed=!1,this.selected_playlist={},this.fetch_time_out=0}static async getConfigElement(){return document.createElement("spotify-card-editor")}static getStubConfig(){return{}}connectedCallback(){var t;super.connectedCallback(),this.spotcast_connector=new Bt(this),void 0!==(t=this.hass.connection,Ct(t,"_srv",Nt,Tt)).state.spotcast&&(this.spotcast_installed=!0),Vt(this.hass.connection,t=>this.entitiesUpdated(t))}entitiesUpdated(t){let e=!1;for(const i in t)i.startsWith("media_player")&&(i.startsWith("media_player.spotify_")&&(this.spotify_installed=!0,this.spotify_state=t[i]),e=!0);e&&(this.fetch_time_out&&clearTimeout(this.fetch_time_out),this.fetch_time_out=setTimeout(()=>{this.spotcast_connector.updateState().then(()=>{console.log("State updated:",(new Date).toISOString()),this.requestUpdate()})},400))}getSpotifyEntityState(){return this.spotify_state?this.spotify_state.state:""}setConfig(t){let e="";if(t.limit&&"number"!=typeof t.limit&&(e="limit"),t.playlist_type&&!Ft.includes(t.playlist_type)&&(e="playlist_type"),t.country_code&&"string"!=typeof t.country_code&&(e="country_code"),t.height&&"number"!=typeof t.height&&(e="height"),t.display_style&&!It.includes(t.display_style)&&(e="display_style"),t.darkmode&&"boolean"!=typeof t.darkmode&&(e="darkmode"),t.show_error||""!=e)throw new Error(Lt("common.invalid_configuration")+": "+e);t.test_gui&&function(){var t=document.querySelector("home-assistant");if(t=(t=(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))&&t.shadowRoot)&&t.querySelector("hui-root")){var e=t.lovelace;return e.current_view=t.___curView,e}return null}().setEditMode(!0),this.config=Object.assign({},t)}spotifyDeviceSelected(t){if(this.spotcast_connector.getCurrentPlayer())return this.spotcast_connector.transferPlaybackToConnectDevice(t.id);const e=this.spotcast_connector.playlists[0];console.log("spotifyDeviceSelected playing first playlist"),this.spotcast_connector.playUriOnConnectDevice(t.id,e.uri)}chromecastDeviceSelected(t){if(this.spotcast_connector.getCurrentPlayer())return this.spotcast_connector.transferPlaybackToCastDevice(t.attributes.friendly_name);const e=this.spotcast_connector.playlists[0];console.log("chromecastDeviceSelected playing first playlist"),this.spotcast_connector.playUriOnCastDevice(t.attributes.friendly_name,e.uri)}render(){let t=A``;this.config.show_warning&&(t=this.showWarning(Lt("common.show_warning"))),this.spotcast_installed||(t=this.showWarning(Lt("common.show_missing_spotcast"))),this.spotify_installed||(t=this.showWarning(Lt("common.show_missing_spotify")));let e=A`<div>Loading...</div>`;!this.spotcast_connector.is_loading()&&this.spotcast_installed?this.spotcast_connector.fetchPlaylists(this.config.limit?this.config.limit:10):e="Grid"==this.config.display_style?this.generateGridView():this.generateListView();const i=this.spotcast_connector.getCurrentPlayer(),s=i?i.name:Lt("common.choose_player");return A`
      <ha-card tabindex="0" style="${this.config.height?`height: ${this.config.height}px`:""}"
        >${this.config.hide_warning?"":t}
        <div id="header">
          <div id="icon">
    ...
    `}generateListView(){var t,e;if(this.spotcast_connector.is_loaded()){const i=[];for(let s=0;s<this.spotcast_connector.playlists.length;s++){const n=this.spotcast_connector.playlists[s];let r="",o="";(null===(t=this.spotify_state)||void 0===t?void 0:t.attributes.media_playlist)===n.name&&(r="playing",o=(null===(e=this.spotify_state)||void 0===e?void 0:e.attributes.shuffle)?"playing":""),i.push(A`<div class="list-item" @click=${()=>this.spotcast_connector.playUri(n.uri)}>
          ...
          <p>${n.name}</p>
        </div>`)}return A`<div>${i}</div>`}return A``}generateGridView(){var t;if(this.spotcast_connector.is_loaded()){const e=[];for(let i=0;i<this.spotcast_connector.playlists.length;i++){const s=this.spotcast_connector.playlists[i];let n="";(null===(t=this.spotify_state)||void 0===t?void 0:t.attributes.media_playlist)===s.name&&(n="playing"),e.push(A`<div class="grid-item ${n}" @click=${()=>this.spotcast_connector.playUri(s.uri)}>
          <img
  ...
  `,t([J({type:Object})],Zt.prototype,"hass",void 0),t([J({type:Object})],Zt.prototype,"config",void 0),t([Z()],Zt.prototype,"spotcast_connector",void 0),Zt=Jt=t([G("spotify-card")],Zt);export{Zt as SpotifyCard};
