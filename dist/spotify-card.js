 ...
 * http://polymer.github.io/PATENTS.txt
 */
class v{constructor(e,t,i){this.__parts=[],this.template=e,this.processor=t,this.options=i}update(e){let t=0;for(const i of this.__parts)void 0!==i&&i.setValue(e[t]),t++;for(const e of this.__parts)void 0!==e&&e.commit()}_clone(){const e=t?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),i=[],s=this.template.parts,n=document.createTreeWalker(e,133,null,!1);let r,o=0,a=0,l=n.nextNode();for(;o<s.length;)if(r=s[o],c(r)){for(;a<r.index;)a++,"TEMPLATE"===l.nodeName&&(i.push(l),n.currentNode=l.content),null===(l=n.nextNode())&&(n.currentNode=i.pop(),l=n.nextNode());if("node"===r.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(l.previousSibling),this.__parts.push(e)}else this.__parts.push(...this.processor.handleAttributeExpressions(l,r.name,r.strings,this.options));o++}else this.__parts.push(void 0),o++;return t&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=` ${s} `;class w{constructor(e,t,i,s){this.strings=e,this.values=t,this.type=i,this.processor=s}getHTML(){const e=this.strings.length-1;let t="",i=!1;for(let r=0;r<e;r++){const e=this.strings[r],o=e.lastIndexOf("\x3c!--");i=(o>-1||i)&&-1===e.indexOf("--\x3e",o+1);const a=d.exec(e);t+=null===a?e+(i?y:n):e.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+s}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function z(e){let t=O.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},O.set(e.type,t));let i=t.stringsArray.get(e.strings);if(void 0!==i)return i;const n=e.strings.join(s);return i=t.keyString.get(n),void 0===i&&(i=new o(e,e.getTemplateElement()),t.keyString.set(n,i)),t.stringsArray.set(e.strings,i),i}const O=new Map,A=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,s){const n=t[0];if("."===n){return new k(e,t.slice(1),i).parts}if("@"===n)return[new T(e,t.slice(1),s.eventContext)];if("?"===n)return[new P(e,t.slice(1),i)];return new x(e,t,i).parts}handleTextExpression(e){return new $(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const D=(e,...t)=>new w(e,t,"html",E)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */,U=(e,t)=>`${e}--${t}`;let j=!0;void 0===window.ShadyCSS?j=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),j=!1);const H=e=>t=>{const i=U(t.type,e);let n=O.get(i);void 0===n&&(n={stringsArray:new WeakMap,keyString:new Map},O.set(i,n));let r=n.stringsArray.get(t.strings);if(void 0!==r)return r;const a=t.strings.join(s);if(r=n.keyString.get(a),void 0===r){const i=t.getTemplateElement();j&&window.ShadyCSS.prepareTemplateDom(i,e),r=new o(t,i),n.keyString.set(a,r)}return n.stringsArray.set(t.strings,r),r},Y=["html","svg"],R=new Set,q=(e,t,i)=>{R.add(e);const s=i?i.element:document.createElement("template"),n=t.querySelectorAll("style"),{length:r}=n;if(0===r)return void window.ShadyCSS.prepareTemplateStyles(s,e);const o=document.createElement("style");for(let e=0;e<r;e++){const t=n[e];t.parentNode.removeChild(t),o.textContent+=t.textContent}(e=>{Y.forEach(t=>{const i=O.get(U(t,e));void 0!==i&&i.keyString.forEach(e=>{const{element:{content:t}}=e,i=new Set;Array.from(t.querySelectorAll("style")).forEach(e=>{i.add(e)}),h(e,i)})})})(e);const a=s.content;i?function(e,t,i=null){const{element:{content:s},parts:n}=e;if(null==i)return void s.appendChild(t);const r=document.createTreeWalker(s,133,null,!1);let o=u(n),a=0,c=-1;for(;r.nextNode();){c++;for(r.currentNode===i&&(a=p(t),i.parentNode.insertBefore(t,i));-1!==o&&n[o].index===c;){if(a>0){for(;-1!==o;)n[o].index+=a,o=u(n,o);return}o=u(n,o)}}}(i,o,a.firstChild):a.insertBefore(o,a.firstChild),window.ShadyCSS.prepareTemplateStyles(s,e);const c=a.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==c)t.insertBefore(c.cloneNode(!0),t.firstChild);else if(i){a.insertBefore(o,a.firstChild);const e=new Set;e.add(o),h(i,e)}};window.JSCompiler_renameProperty=(e,t)=>e;const L={toAttribute(e,t){switch(t){case Boolean:return e?"":null;case Object:case Array:return null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){switch(t){case Boolean:return null!==e;case Number:return null===e?null:Number(e);case Object:case Array:return JSON.parse(e)}return e}},W=(e,t)=>t!==e&&(t==t||e==e),F={attribute:!0,type:String,converter:L,reflect:!1,hasChanged:W};class I extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=new Promise(e=>this._enableUpdatingResolver=e),this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const e=[];return this._classProperties.forEach((t,i)=>{const s=this._attributeNameForProperty(i,t);void 0!==s&&(this._attributeToPropertyMap.set(s,i),e.push(s))}),e}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const e=Object.getPrototypeOf(this)._classProperties;void 0!==e&&e.forEach((e,t)=>this._classProperties.set(t,e))}}static createProperty(e,t=F){if(this._ensureClassProperties(),this._classProperties.set(e,t),t.noAccessor||this.prototype.hasOwnProperty(e))return;const i="symbol"==typeof e?Symbol():"__"+e,s=this.getPropertyDescriptor(e,i,t);void 0!==s&&Object.defineProperty(this.prototype,e,s)}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(i){const s=this[e];this[t]=i,this._requestUpdate(e,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this._classProperties&&this._classProperties.get(e)||F}static finalize(){const e=Object.getPrototypeOf(this);if(e.hasOwnProperty("finalized")||e.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const e=this.properties,t=[...Object.getOwnPropertyNames(e),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(e):[]];for(const i of t)this.createProperty(i,e[i])}}static _attributeNameForProperty(e,t){const i=t.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof e?e.toLowerCase():void 0}static _valueHasChanged(e,t,i=W){return i(e,t)}static _propertyValueFromAttribute(e,t){const i=t.type,s=t.converter||L,n="function"==typeof s?s:s.fromAttribute;return n?n(e,i):e}static _propertyValueToAttribute(e,t){if(void 0===t.reflect)return;const i=t.type,s=t.converter;return(s&&s.toAttribute||L.toAttribute)(e,i)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((e,t)=>{if(this.hasOwnProperty(t)){const e=this[t];delete this[t],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(t,e)}})}_applyInstanceProperties(){this._instanceProperties.forEach((e,t)=>this[t]=e),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(e,t,i){t!==i&&this._attributeToProperty(e,i)}_propertyToAttribute(e,t,i=F){const s=this.constructor,n=s._attributeNameForProperty(e,i);if(void 0!==n){const e=s._propertyValueToAttribute(t,i);if(void 0===e)return;this._updateState=8|this._updateState,null==e?this.removeAttribute(n):this.setAttribute(n,e),this._updateState=-9&this._updateState}}_attributeToProperty(e,t){if(8&this._updateState)return;const i=this.constructor,s=i._attributeToPropertyMap.get(e);if(void 0!==s){const e=i.getPropertyOptions(s);this._updateState=16|this._updateState,this[s]=i._propertyValueFromAttribute(t,e),this._updateState=-17&this._updateState}}_requestUpdate(e,t){let i=!0;if(void 0!==e){const s=this.constructor,n=s.getPropertyOptions(e);s._valueHasChanged(this[e],t,n.hasChanged)?(this._changedProperties.has(e)||this._changedProperties.set(e,t),!0!==n.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(e,n))):i=!1}!this._hasRequestedUpdate&&i&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(e,t){return this._requestUpdate(e,t),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(e){}const e=this.performUpdate();return null!=e&&await e,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let e=!1;const t=this._changedProperties;try{e=this.shouldUpdate(t),e?this.update(t):this._markUpdated()}catch(t){throw e=!1,this._markUpdated(),t}e&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(t)),this.updated(t))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(e){return!0}update(e){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((e,t)=>this._propertyToAttribute(t,this[t],e)),this._reflectingProperties=void 0),this._markUpdated()}updated(e){}firstUpdated(e){}}I.finalized=!0;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const G=e=>t=>"function"==typeof t?((e,t)=>(window.customElements.define(e,t),t))(e,t):((e,t)=>{const{kind:i,elements:s}=t;return{kind:i,elements:s,finisher(t){window.customElements.define(e,t)}}})(e,t),B=(e,t)=>"method"===t.kind&&t.descriptor&&!("value"in t.descriptor)?Object.assign(Object.assign({},t),{finisher(i){i.createProperty(t.key,e)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof t.initializer&&(this[t.key]=t.initializer.call(this))},finisher(i){i.createProperty(t.key,e)}};function J(e){return(t,i)=>void 0!==i?((e,t,i)=>{t.constructor.createProperty(i,e)})(e,t,i):B(e,t)}function K(e){return J({attribute:!1,hasChanged:null==e?void 0:e.hasChanged})}
/**
@license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const te={};class ie extends I{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const t=(e,i)=>e.reduceRight((e,i)=>Array.isArray(i)?t(i,e):(e.add(i),e),i),i=t(e,new Set),s=[];i.forEach(e=>s.unshift(e)),this._styles=s}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Z?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==te&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return te}}ie.finalized=!0,ie.render=(e,t,s)=>{if(!s||"object"!=typeof s||!s.scopeName)throw new Error("The `scopeName` option is required.");const n=s.scopeName,r=A.has(t),o=j&&11===t.nodeType&&!!t.host,a=o&&!R.has(n),c=a?document.createDocumentFragment():t;if(((e,t,s)=>{let n=A.get(t);void 0===n&&(i(t,t.firstChild),A.set(t,n=new $(Object.assign({templateFactory:z},s))),n.appendInto(t)),n.setValue(e),n.commit()})(e,c,Object.assign({templateFactory:H(n)},s)),a){const e=A.get(c);A.delete(c);const s=e.value instanceof v?e.value.template:void 0;q(n,c,s),i(t,t.firstChild),t.appendChild(c),A.set(t,e)}!r&&o&&window.ShadyCSS.styleElement(t.host)};var se=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,ne="[^\\s]+",re=/\[([^]*?)\]/gm;function oe(e,t){for(var i=[],s=0,n=e.length;s<n;s++)i.push(e[s].substr(0,t));return i}var ae=function(e){return function(t,i){var s=i[e].map((function(e){return e.toLowerCase()})).indexOf(t.toLowerCase());return s>-1?s:null}};function ce(e){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];for(var s=0,n=t;s<n.length;s++){var r=n[s];for(var o in r)e[o]=r[o]}return e}var le=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],de=["January","February","March","April","May","June","July","August","September","October","November","December"],he=oe(de,3),pe={dayNamesShort:oe(le,3),dayNames:le,monthNamesShort:he,monthNames:de,amPm:["am","pm"],DoFn:function(e){return e+["th","st","nd","rd"][e%10>3?0:(e-e%10!=10?1:0)*e%10]}},ue=ce({},pe),ge=function(e,t){for(void 0===t&&(t=2),e=String(e);e.length<t;)e="0"+e;return e},_e={D:function(e){return String(e.getDate())},DD:function(e){return ge(e.getDate())},Do:function(e,t){return t.DoFn(e.getDate())},d:function(e){return String(e.getDay())},dd:function(e){return ge(e.getDay())},ddd:function(e,t){return t.dayNamesShort[e.getDay()]},dddd:function(e,t){return t.dayNames[e.getDay()]},M:function(e){return String(e.getMonth()+1)},MM:function(e){return ge(e.getMonth()+1)},MMM:function(e,t){return t.monthNamesShort[e.getMonth()]},MMMM:function(e,t){return t.monthNames[e.getMonth()]},YY:function(e){return ge(String(e.getFullYear()),4).substr(2)},YYYY:function(e){return ge(e.getFullYear(),4)},h:function(e){return String(e.getHours()%12||12)},hh:function(e){return ge(e.getHours()%12||12)},H:function(e){return String(e.getHours())},HH:function(e){return ge(e.getHours())},m:function(e){return String(e.getMinutes())},mm:function(e){return ge(e.getMinutes())},s:function(e){return String(e.getSeconds())},ss:function(e){return ge(e.getSeconds())},S:function(e){return String(Math.round(e.getMilliseconds()/100))},SS:function(e){return ge(Math.round(e.getMilliseconds()/10),2)},SSS:function(e){return ge(e.getMilliseconds(),3)},a:function(e,t){return e.getHours()<12?t.amPm[0]:t.amPm[1]},A:function(e,t){return e.getHours()<12?t.amPm[0].toUpperCase():t.amPm[1].toUpperCase()},ZZ:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+ge(100*Math.floor(Math.abs(t)/60)+Math.abs(t)%60,4)},Z:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+ge(Math.floor(Math.abs(t)/60),2)+":"+ge(Math.abs(t)%60,2)}},me=function(e){return+e-1},fe=[null,"[1-9]\\d?"],ve=[null,ne],ye=["isPm",ne,function(e,t){var i=e.toLowerCase();return i===t.amPm[0]?0:i===t.amPm[1]?1:null}],we=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(e){var t=(e+"").match(/([+-]|\d\d)/gi);if(t){var i=60*+t[1]+parseInt(t[2],10);return"+"===t[0]?i:-i}return 0}],be=(ae("monthNamesShort"),ae("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var Se=function(e,t,i){if(void 0===t&&(t=be.default),void 0===i&&(i={}),"number"==typeof e&&(e=new Date(e)),"[object Date]"!==Object.prototype.toString.call(e)||isNaN(e.getTime()))throw new Error("Invalid Date pass to format");var s=[];t=(t=be[t]||t).replace(re,(function(e,t){return s.push(t),"@@@"}));var n=ce(ce({},ue),i);return(t=t.replace(se,(function(t){return _e[t](e,n)}))).replace(/@@@/g,(function(){return s.shift()}))},xe=(function(){try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}}(),function(e,t,i,s){s=s||{},i=null==i?{}:i;var n=new Event(t,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,e.dispatchEvent(n),n});const Ce=e=>{let t=[];function i(i,s){e=s?i:Object.assign(Object.assign({},e),i);let n=t;for(let t=0;t<n.length;t++)n[t](e)}return{get state(){return e},action(t){function s(e){i(e,!1)}return function(){let i=[e];for(let e=0;e<arguments.length;e++)i.push(arguments[e]);let n=t.apply(this,i);if(null!=n)return n instanceof Promise?n.then(s):s(n)}},setState:i,subscribe:e=>(t.push(e),()=>{!function(e){let i=[];for(let s=0;s<t.length;s++)t[s]===e?e=null:i.push(t[s]);t=i}(e)})}},$e=(e,t,i,s)=>{if(e[t])return e[t];let n,r=0,o=Ce();const a=()=>i(e).then(e=>o.setState(e,!0)),c=()=>a().catch(t=>{if(e.connected)throw t});return e[t]={get state(){return o.state},refresh:a,subscribe(t){r++,1===r&&(s&&(n=s(e,o)),e.addEventListener("ready",c),c());const i=o.subscribe(t);return void 0!==o.state&&setTimeout(()=>t(o.state),0),()=>{i(),r--,r||(n&&n.then(e=>{e()}),e.removeEventListener("ready",a))}}},e[t]},Pe=e=>e.sendMessagePromise({type:"get_states"});function ke(e,t){if(void 0===e)return null;const{domain:i,service:s}=t.data;return{[i]:Object.assign({},e[i],{[s]:{description:"",fields:{}}})}}function Me(e,t){if(void 0===e)return null;const{domain:i,service:s}=t.data,n=e[i];if(!n||!(s in n))return null;const r={};return Object.keys(n).forEach(e=>{e!==s&&(r[e]=n[e])}),{[i]:r}}const Ne=e=>e.sendMessagePromise({type:"get_services"}),Te=(e,t)=>Promise.all([e.subscribeEvents(t.action(ke),"service_registered"),e.subscribeEvents(t.action(Me),"service_removed")]).then(e=>()=>e.forEach(e=>e()));async function Ve(e){const t=await Pe(e),i={};for(let e=0;e<t.length;e++){const s=t[e];i[s.entity_id]=s}return i}const ze=(e,t)=>e.subscribeEvents(e=>function(e,t){const i=e.state;if(void 0===i)return;const{entity_id:s,new_state:n}=t.data;if(n)e.setState({[n.entity_id]:n});else{const t=Object.assign({},i);delete t[s],e.setState(t,!0)}}(t,e),"state_changed"),Oe=(e,t)=>(e=>$e(e,"_ent",Ve,ze))(e).subscribe(t);var Ae={version:"Version",description:"A custom card for displaying Spotify-Playlist and starting playback",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_missing_spotcast:"Spotcast integration has to be installed for this component to work",show_missing_spotify:"Spotify integration has to be installed for playback information",choose_player:"Choose player"},Ee={general:"General",general_description:"General settings for this card",appearance:"Appearance",appearance_description:"Customize the style, icon, etc",advanced:"Advanced",advanced_description:"Customize advanced settings",hide_warning:"Hide warnings",playlist_type:"Playlist Type",limit:"Amount of playlists shown",height:"Height of card",country_code:"Country Code for featured playlists",always_play_random_song:"Always play random song when starting playback",title:"Title of card",display_style:"Display Style",grid_cover_size:"Cover size in Grid-View in pixels",grid_center_covers:"Center the covers in Grid-View",account:"Account",filter_out_cast_devices:"Filter out chromecast devices"},De={common:Ae,settings:Ee},Ue={version:"Version",description:"Eine Karte um Spotify-Playlist anzuzeigen und abzuspielen",invalid_configuration:"Ungültige Konfiguration",show_warning:"Warnung",show_missing_spotcast:"Die Spotcast-Integration muss installiert sein, damit diese Karte funktioniert",show_missing_spotify:"Die Spotify-Integration muss installiert sein, damit der Spotify-Status angezeigt werden kann"},je={general:"Generell",general_description:"Generelle Einstellungen",appearance:"Aussehen",appearance_description:"Passe den Stil und anderes an",hide_warning:"Verstecke Warnhinweise",playlist_type:"Playlist Typ",limit:"Anzahl an angezeigten Playlisten",height:"Höhe der Karte",country_code:"Länder-Code für die Featured-Playlist",always_play_random_song:"Spiele immer einen zufälligen Song beim Starten der Wiedergabe ab",title:"Titel der Karte",display_style:"Anzeige-Stil",grid_cover_size:"Cover Größe in der Karten-Ansicht in Pixeln",grid_center_covers:"Zentriere die Cover in der Karten-Ansicht"},He={common:Ue,settings:je},Ye={version:"Version",description:"A custom card for displaying Spotify-Playlist and starting playback",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_missing_spotcast:"Spotcast integration has to be installed for this component to work",show_missing_spotify:"Spotify integration has to be installed for playback information"},Re={general:"General",general_description:"General settings for this card",appearance:"Appearance",appearance_description:"Customize the style, icon, etc",hide_warning:"Hide warnings",playlist_type:"Playlist Type",limit:"Amount of playlists shown",height:"Height of card",country_code:"Country Code for featured playlists",always_play_random_song:"Always play random song when starting playback",title:"Title of card",display_style:"Display Style",grid_cover_size:"Cover size in Grid-View in pixels",grid_center_covers:"Center the covers in Grid-View"},qe={common:Ye,settings:Re};const Le={en:Object.freeze({__proto__:null,common:Ae,settings:Ee,default:De}),de:Object.freeze({__proto__:null,common:Ue,settings:je,default:He}),se:Object.freeze({__proto__:null,common:Ye,settings:Re,default:qe})};function We(e,t="",i=""){const s=e.split(".")[0],n=e.split(".")[1],r=(localStorage.getItem("selectedLanguage")||navigator.language.split("-")[0]||"en").replace(/['"]+/g,"").replace("-","_");let o;try{o=Le[r][s][n]}catch(e){o=Le.en[s][n]}return void 0===o&&(o=Le.en[s][n]),""!==t&&""!==i&&(o=o.replace(t,i)),o}const Fe={general:{icon:"tune",name:We("settings.general"),secondary:We("settings.general_description"),show:!1},appearance:{icon:"palette",name:We("settings.appearance"),secondary:We("settings.appearance_description"),show:!1},advanced:{icon:"pencil",name:We("settings.advanced"),secondary:We("settings.advanced_description"),show:!0}},Ie=["Default","featured","discover-weekly"],Ge=["List","Grid"];let Be=class extends ie{constructor(){super(...arguments),this.accounts=[],this.hidden_cast_devices=[],this.chromecast_devices=[]}async connectedCallback(){super.connectedCallback();const e=await this.hass.callWS({type:"spotcast/accounts"});this.accounts=e;this.chromecast_devices=[{ddd:123,friendly_name:"Kök"},{ddd:122,friendly_name:"Högtalare uppe"},{ddd:112,friendly_name:"Vardagsrum"},{ddd:345,friendly_name:"Kök 2"},{ddd:567,friendly_name:"Högtalare uppe 2"},{ddd:789,friendly_name:"Vardagsrum 3"}].map(e=>e.friendly_name),this.requestUpdate()}setConfig(e){this._config=e}get _name(){return this._config&&this._config.name||""}get _account(){return this._config?this._config._account||"default":""}get _country_code(){return this._config&&this._config.country_code||""}get _limit(){return this._config&&this._config.limit||10}get _playlist_type(){return this._config?this._config.playlist_type||"Default":""}get _always_play_random_song(){return this._config&&this._config.always_play_random_song||!1}get _height(){return this._config&&this._config.height||""}get _display_style(){return this._config&&this._config.display_style||"List"}get _grid_cover_size(){return this._config&&this._config.grid_cover_size||100}get _grid_center_covers(){return this._config&&this._config.grid_center_covers||!1}get _hidden_cast_devices(){return this._config&&this._config.hidden_cast_devices||[]}get _hide_warning(){return this._config&&this._config.hide_warning||!1}get _show_warning(){return this._config&&this._config.show_warning||!1}get _show_error(){return this._config&&this._config.show_error||!1}renderGeneral(){return D`
      <div class="values">
        <div>
          <paper-dropdown-menu
            label=${We("settings.account")}
            @value-changed=${this._valueChanged}
            .configValue=${"account"}
          >
            <paper-listbox slot="dropdown-content" .selected=${this.accounts.indexOf(this._account)}>
              ${this.accounts.map(e=>D` <paper-item>${e}</paper-item> `)}
            </paper-listbox>
          </paper-dropdown-menu>
        </div>
        <div>
          <paper-dropdown-menu
            label=${We("settings.playlist_type")}
            @value-changed=${this._valueChanged}
            .configValue=${"playlist_type"}
          >
            <paper-listbox slot="dropdown-content" .selected=${Ie.indexOf(this._playlist_type)}>
              ${Ie.map(e=>D` <paper-item>${e}</paper-item> `)}
            </paper-listbox>
          </paper-dropdown-menu>
        </div>
        <div>
          <div>${We("settings.limit")}</div>
          <paper-slider
            .value=${this._limit}
            .configValue=${"limit"}
            @value-changed=${this._valueChanged}
        ...
        <div>
          <paper-input
            label=${We("settings.country_code")}
        ...
        <div>
          <div>${We("settings.always_play_random_song")}</div>
          <ha-switch
      ...
      <div class="values">
        <div>
          <ha-switch
            ...
            @change=${this._valueChanged}
            >${We("settings.hide_warning")}</ha-switch
          >
        </div>
        <div>
          <paper-input
            label=${We("settings.title")}
            .value=${this._name}
            .configValue=${"name"}
            @value-changed=${this._valueChanged}
          ></paper-input>
        ...
        <div>
          <paper-dropdown-menu
            label=${We("settings.display_style")}
            @value-changed=${this._valueChanged}
            .configValue=${"display_style"}
          >
            <paper-listbox slot="dropdown-content" .selected=${Ge.indexOf(this._display_style)}>
              ${Ge.map(e=>D` <paper-item>${e}</paper-item> `)}
            </paper-listbox>
          </paper-dropdown-menu>
        </div>
        <div>
          <div>${We("settings.grid_cover_size")}</div>
          <paper-slider
        ...
        <div>
          <div>${We("settings.grid_center_covers")}</div>
          <ha-switch
    ...
    `}renderAdvanced(){return D`
      <div class="values">
        <div class="filter_grid">
          <div class="filter_grid--title">${We("settings.filter_out_cast_devices")}</div>
          ${this.chromecast_devices.map((e,t)=>D`
              <paper-checkbox
                .idx=${t}
                .checked=${this._hidden_cast_devices.includes(e)}
    ...
    `}render(){return this.hass?D`
      <div class="card-config">
        <div class="option" @click=${this._toggleOption} .option=${"general"}>
          <div class="row">
            <ha-icon .icon=${"mdi:"+Fe.general.icon}></ha-icon>
            <div class="title">${Fe.general.name}</div>
          </div>
          <div class="secondary">${Fe.general.secondary}</div>
        </div>
        ${Fe.general.show?this.renderGeneral():""}
        <div class="option" @click=${this._toggleOption} .option=${"appearance"}>
          <div class="row">
            <ha-icon .icon=${"mdi:"+Fe.appearance.icon}></ha-icon>
            <div class="title">${Fe.appearance.name}</div>
          </div>
          <div class="secondary">${Fe.appearance.secondary}</div>
        </div>
        ${Fe.appearance.show?this.renderAppearance():""}
        <div class="option" @click=${this._toggleOption} .option=${"advanced"}>
          <div class="row">
            <ha-icon .icon=${"mdi:"+Fe.advanced.icon}></ha-icon>
            <div class="title">${Fe.advanced.name}</div>
          </div>
          <div class="secondary">${Fe.advanced.secondary}</div>
        </div>
        ${Fe.advanced.show?this.renderAdvanced():""}
      </div>
    `:D``}_toggleOption(e){this._toggleThing(e,Fe)}_toggleThing(e,t){const i=!t[e.target.option].show;for(const[e]of Object.entries(t))t[e].show=!1;t[e.target.option].show=i,this._toggle=!this._toggle}_valueChanged(e){if(!this._config||!this.hass||null===e.target.offsetParent)return;const{target:t}=e;if(this["_"+t.configValue]!==t.value){if(t.configValue)if(!1===t.checked||""===t.value){const e=Object.assign({},this._config);delete e[t.configValue],this._config=e}else"height"==t.configValue&&(t.value=Number(t.value)),this._config=Object.assign(Object.assign({},this._config),{[t.configValue]:void 0!==t.checked?t.checked:t.value});xe(this,"config-changed",{config:this._config}),this.requestUpdate(t.configValue)}}_valueChangedForList(e){if(!this._config||!this.hass)return;const{checked:t}=e.currentTarget,i=e.target.configValue,s=e.target.innerText,n=JSON.parse(JSON.stringify(this._config));n[i]||(n[i]=[]),t?n[i].includes(s)||n[i].push(s):n[i]=n[i].filter(e=>e!==s),xe(this,"config-changed",{config:n}),this.requestUpdate(i)}static get styles(){return ee`
      .option {
        padding: 4px 0px;
        cursor: pointer;
      }
    ...
    `}};e([J({type:Object})],Be.prototype,"hass",void 0),e([K()],Be.prototype,"_config",void 0),e([K()],Be.prototype,"_toggle",void 0),Be=e([G("spotify-card-editor")],Be);class Je{constructor(e){this.playlists=[],this.devices=[],this.chromecast_devices=[],this.state_ttl=2e3,this.last_state_update_time=0,this.loading=!1,this.parent=e}is_loading(){return setTimeout(this.set_loading_off,100),this.loading}set_loading_off(){this.loading=!1}is_loaded(){return void 0!==this.playlists.length}getPlaybackOptions(e){return{uri:e,force_playback:"playing"==this.parent.getSpotifyEntityState(),random_song:this.parent.config.always_play_random_song||!1,account:this.parent.config.account}}playUri(e){const t=this.getCurrentPlayer();t?this.playUriOnConnectDevice(t.id,e):console.error("No active device")}transferPlaybackToCastDevice(e){this.parent.hass.callService("spotcast","start",{device_name:e,force_playback:!0,account:this.parent.config.account})}transferPlaybackToConnectDevice(e){this.parent.hass.callService("spotcast","start",{spotify_device_id:e,force_playback:!0,account:this.parent.config.account})}playUriOnCastDevice(e,t){const i=Object.assign(Object.assign({},this.getPlaybackOptions(t)),{device_name:e});this.parent.hass.callService("spotcast","start",i)}playUriOnConnectDevice(e,t){const i=Object.assign(Object.assign({},this.getPlaybackOptions(t)),{spotify_device_id:e});this.parent.hass.callService("spotcast","start",i)}async updateState(){(new Date).getTime()-this.last_state_update_time<this.state_ttl?console.log("cache is still valid:",this.last_state_update_time):(console.log("cache is NOT valid:",this.last_state_update_time),await this.fetchDevices(),await this.fetchPlayer(),await this.fetchChromecasts(),this.last_state_update_time=(new Date).getTime())}getCurrentPlayer(){var e;return null===(e=this.player)||void 0===e?void 0:e.device}async fetchPlayer(){const e={type:"spotcast/player",account:this.parent.config.account};this.player=await this.parent.hass.callWS(e)}async fetchDevices(){const e={type:"spotcast/devices",account:this.parent.config.account},t=await this.parent.hass.callWS(e);this.devices=t.devices}async fetchChromecasts(){const e=await this.parent.hass.callWS({type:"spotcast/castdevices"}),t=await this.parent.hass.callWS({type:"config/entity_registry/list"});this.chromecast_devices=t.filter(e=>"cast"==e.platform).map(e=>this.parent.hass.states[e.entity_id]).filter(e=>null!=e&&"unavailable"!=e.state),console.log("fetchChromecasts:",this.chromecast_devices),console.log("fetchChromecasts2:",e)}async fetchPlaylists(){this.loading=!0;const e={type:"spotcast/playlists",playlist_type:this.parent.config.playlist_type||"",account:this.parent.config.account,limit:this.parent.config.limit};this.parent.config.country_code&&(e.country_code=this.parent.config.country_code);const t=await this.parent.hass.callWS(e);this.playlists=t.items}}var Ke;console.info(`%c  SPOTIFY-CARD \n%c  ${We("common.version")} 2.0.0    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"spotify-card",name:"Spotify Card",description:We("common.description"),preview:!0});let Ze=Ke=class extends ie{constructor(){super(...arguments),this.spotcast_installed=!1,this.spotify_installed=!1,this.fetch_time_out=0}static async getConfigElement(){return document.createElement("spotify-card-editor")}static getStubConfig(){return{}}connectedCallback(){var e;super.connectedCallback(),this.spotcast_connector=new Je(this),void 0!==(e=this.hass.connection,$e(e,"_srv",Ne,Te)).state.spotcast&&(this.spotcast_installed=!0),Oe(this.hass.connection,e=>this.entitiesUpdated(e))}entitiesUpdated(e){let t=!1;for(const i in e)i.startsWith("media_player")&&(i.startsWith("media_player.spotify_")&&(this.spotify_installed=!0,this.spotify_state=e[i]),t=!0);t&&(this.fetch_time_out&&clearTimeout(this.fetch_time_out),this.fetch_time_out=setTimeout(()=>{this.spotcast_connector.updateState().then(()=>{console.log("State updated:",(new Date).toISOString()),this.requestUpdate()})},500))}getSpotifyEntityState(){return this.spotify_state?this.spotify_state.state:""}setConfig(e){let t="";if(e.limit&&"number"!=typeof e.limit&&(t="limit"),e.playlist_type&&!Ie.includes(e.playlist_type)&&(t="playlist_type"),e.country_code&&"string"!=typeof e.country_code&&(t="country_code"),e.height&&"number"!=typeof e.height&&(t="height"),e.display_style&&!Ge.includes(e.display_style)&&(t="display_style"),e.darkmode&&"boolean"!=typeof e.darkmode&&(t="darkmode"),e.show_error||""!=t)throw new Error(We("common.invalid_configuration")+": "+t);e.test_gui&&function(){var e=document.querySelector("home-assistant");if(e=(e=(e=(e=(e=(e=(e=(e=e&&e.shadowRoot)&&e.querySelector("home-assistant-main"))&&e.shadowRoot)&&e.querySelector("app-drawer-layout partial-panel-resolver"))&&e.shadowRoot||e)&&e.querySelector("ha-panel-lovelace"))&&e.shadowRoot)&&e.querySelector("hui-root")){var t=e.lovelace;return t.current_view=e.___curView,t}return null}().setEditMode(!0),this.config=Object.assign({},e)}spotifyDeviceSelected(e){if(this.spotcast_connector.getCurrentPlayer())return this.spotcast_connector.transferPlaybackToConnectDevice(e.id);const t=this.spotcast_connector.playlists[0];console.log("spotifyDeviceSelected playing first playlist"),this.spotcast_connector.playUriOnConnectDevice(e.id,t.uri)}chromecastDeviceSelected(e){if(this.spotcast_connector.getCurrentPlayer())return this.spotcast_connector.transferPlaybackToCastDevice(e.attributes.friendly_name);const t=this.spotcast_connector.playlists[0];console.log("chromecastDeviceSelected playing first playlist"),this.spotcast_connector.playUriOnCastDevice(e.attributes.friendly_name,t.uri)}onShuffleSelect(){var e;console.log("shuffle;",this.spotify_state),"playing"==(null===(e=this.spotify_state)||void 0===e?void 0:e.state)&&this.hass.callService("media_player","shuffle_set",{entity_id:this.spotify_state.entity_id,shuffle:!0})}handlePlayPauseEvent(e,t){e.stopPropagation(),this.spotify_state&&this.hass.callService("media_player",t,{entity_id:this.spotify_state.entity_id})}onPauseSelect(e){this.handlePlayPauseEvent(e,"media_pause")}onResumeSelect(e){this.handlePlayPauseEvent(e,"media_play")}render(){var e,t;let i=D``;this.config.show_warning&&(i=this.showWarning(We("common.show_warning"))),this.spotcast_installed||(i=this.showWarning(We("common.show_missing_spotcast"))),this.spotify_installed||(i=this.showWarning(We("common.show_missing_spotify")));let s=D`<div>Loading...</div>`;!this.spotcast_connector.is_loading()&&this.spotcast_installed?this.spotcast_connector.fetchPlaylists().then(()=>{this.requestUpdate()}):s="Grid"==this.config.display_style?this.generateGridView():this.generateListView();const n=this.spotcast_connector.getCurrentPlayer(),r=null!==(e=null==n?void 0:n.name)&&void 0!==e?e:We("common.choose_player");return D`
      <ha-card tabindex="0" style="${this.config.height?`height: ${this.config.height}px`:""}"
        ...
        <div id="header">
          ...
          ${this.config.name?D`<div id="header_name">${this.config.name}</div>`:""}
          <div></div>
        </div>
        <div id="content">
          ${s}
        ...
        <div id="footer">
          ...
          <div class="footer__right">
            ${"playing"==(null===(t=this.spotify_state)||void 0===t?void 0:t.state)?D`<div class="icon playing" @click=${this.onShuffleSelect}>
    ...
    `}generateDeviceList(){var e;const t=null!==(e=this.config.hidden_cast_devices)&&void 0!==e?e:[];return D`
      <div class="dropdown-content">
        <p>Spotify Connect devices</p>
        ${this.spotcast_connector.devices.map(e=>D` <a @click=${()=>this.spotifyDeviceSelected(e)}>${e.name}</a> `)}
        ${this.spotcast_connector.chromecast_devices.length?D`<p>Chromecast devices</p>`:null}
        ${this.spotcast_connector.chromecast_devices.map(e=>t.includes(e.attributes.friendly_name)?null:D`<a @click=${()=>this.chromecastDeviceSelected(e)}>${e.attributes.friendly_name}</a>`)}
      </div>
    `}generateButtonForCurrent(){var e;return"playing"==(null===(e=this.spotify_state)||void 0===e?void 0:e.state)?D`<div class="icon playing" @click=${this.onPauseSelect}>
        <svg width="24" height="24" viewBox="0 0 500 1000">
          <path d="M0 832h192V192H0V832zM320 192v640h192V192H320z" />
        </svg>
      </div>`:D`<div class="icon playing" @click=${this.onResumeSelect}>
        <svg width="24" height="24">
          <path d="M0 0h24v24H0z" fill="none" />
          <path d="M8 5v14l11-7z" />
        </svg>
      </div>`}generateListView(){var e;if(this.spotcast_connector.is_loaded()){const t=[];for(let i=0;i<this.spotcast_connector.playlists.length;i++){const s=this.spotcast_connector.playlists[i],n=(null===(e=this.spotify_state)||void 0===e?void 0:e.attributes.media_playlist)===s.name;t.push(D`<div class="list-item" @click=${()=>this.spotcast_connector.playUri(s.uri)}>
          <img src="${s.images[s.images.length-1].url}" />

          ${n?this.generateButtonForCurrent():D`<div class="icon">
                <svg width="24" height="24">
                  <path d="M0 0h24v24H0z" fill="none" />
                  <path d="M8 5v14l11-7z" />
                </svg>
          ...
          <p>${s.name}</p>
        </div>`)}return D`<div>${t}</div>`}return D``}generateGridIconForCurrent(){var e;return"playing"==(null===(e=this.spotify_state)||void 0===e?void 0:e.state)?D` <svg width="24" height="24" viewBox="0 0 500 1000" @click=${this.onPauseSelect}>
        <path d="M0 832h192V192H0V832zM320 192v640h192V192H320z" />
      </svg>`:D` <svg width="24" height="24" @click=${this.onResumeSelect}>
        <path d="M0 0h24v24H0z" fill="none" />
        <path d="M8 5v14l11-7z" />
      </svg>`}generateGridView(){var e,t;if(this.spotcast_connector.is_loaded()){const i=[];for(let s=0;s<this.spotcast_connector.playlists.length;s++){const n=this.spotcast_connector.playlists[s],r=(null===(e=this.spotify_state)||void 0===e?void 0:e.attributes.media_playlist)===n.name;null===(t=this.spotify_state)||void 0===t||t.attributes.media_playlist,n.name,i.push(D`<div
          class="grid-item ${r?"playing":""}"
        ...
        >
          ...
          <div class="grid-item-overlay-icon">
            ${r?this.generateGridIconForCurrent():D`
      ...
      >
        ${i}
      </div>`}return D``}showWarning(e){return D`<hui-warning>${e}</hui-warning>`}static get styles(){return[Ke.generalStyles,Ke.listStyles,Ke.gridStyles]}};Ze.generalStyles=ee`
    *:focus {
      outline: none;
    }
  ...
  `,e([J({type:Object})],Ze.prototype,"hass",void 0),e([J({type:Object})],Ze.prototype,"config",void 0),e([K()],Ze.prototype,"spotcast_connector",void 0),Ze=Ke=e([G("spotify-card")],Ze);export{Ze as SpotifyCard};
