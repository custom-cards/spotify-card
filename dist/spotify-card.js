 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function z(e){let t=O.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},O.set(e.type,t));let i=t.stringsArray.get(e.strings);if(void 0!==i)return i;const n=e.strings.join(s);return i=t.keyString.get(n),void 0===i&&(i=new r(e,e.getTemplateElement()),t.keyString.set(n,i)),t.stringsArray.set(e.strings,i),i}const O=new Map,A=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const E=(e,...t)=>new w(e,t,"html",D)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const te={};class ie extends I{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const t=(e,i)=>e.reduceRight((e,i)=>Array.isArray(i)?t(i,e):(e.add(i),e),i),i=t(e,new Set),s=[];i.forEach(e=>s.unshift(e)),this._styles=s}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?K?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==te&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return te}}ie.finalized=!0,ie.render=(e,t,s)=>{if(!s||"object"!=typeof s||!s.scopeName)throw new Error("The `scopeName` option is required.");const n=s.scopeName,o=A.has(t),r=j&&11===t.nodeType&&!!t.host,a=r&&!R.has(n),c=a?document.createDocumentFragment():t;if(((e,t,s)=>{let n=A.get(t);void 0===n&&(i(t,t.firstChild),A.set(t,n=new $(Object.assign({templateFactory:z},s))),n.appendInto(t)),n.setValue(e),n.commit()})(e,c,Object.assign({templateFactory:H(n)},s)),a){const e=A.get(c);A.delete(c);const s=e.value instanceof v?e.value.template:void 0;q(n,c,s),i(t,t.firstChild),t.appendChild(c),A.set(t,e)}!o&&r&&window.ShadyCSS.styleElement(t.host)};var se=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,ne="[^\\s]+",oe=/\[([^]*?)\]/gm;function re(e,t){for(var i=[],s=0,n=e.length;s<n;s++)i.push(e[s].substr(0,t));return i}var ae=function(e){return function(t,i){var s=i[e].map((function(e){return e.toLowerCase()})).indexOf(t.toLowerCase());return s>-1?s:null}};function ce(e){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];for(var s=0,n=t;s<n.length;s++){var o=n[s];for(var r in o)e[r]=o[r]}return e}var le=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],de=["January","February","March","April","May","June","July","August","September","October","November","December"],he=re(de,3),pe={dayNamesShort:re(le,3),dayNames:le,monthNamesShort:he,monthNames:de,amPm:["am","pm"],DoFn:function(e){return e+["th","st","nd","rd"][e%10>3?0:(e-e%10!=10?1:0)*e%10]}},ue=ce({},pe),ge=function(e,t){for(void 0===t&&(t=2),e=String(e);e.length<t;)e="0"+e;return e},_e={D:function(e){return String(e.getDate())},DD:function(e){return ge(e.getDate())},Do:function(e,t){return t.DoFn(e.getDate())},d:function(e){return String(e.getDay())},dd:function(e){return ge(e.getDay())},ddd:function(e,t){return t.dayNamesShort[e.getDay()]},dddd:function(e,t){return t.dayNames[e.getDay()]},M:function(e){return String(e.getMonth()+1)},MM:function(e){return ge(e.getMonth()+1)},MMM:function(e,t){return t.monthNamesShort[e.getMonth()]},MMMM:function(e,t){return t.monthNames[e.getMonth()]},YY:function(e){return ge(String(e.getFullYear()),4).substr(2)},YYYY:function(e){return ge(e.getFullYear(),4)},h:function(e){return String(e.getHours()%12||12)},hh:function(e){return ge(e.getHours()%12||12)},H:function(e){return String(e.getHours())},HH:function(e){return ge(e.getHours())},m:function(e){return String(e.getMinutes())},mm:function(e){return ge(e.getMinutes())},s:function(e){return String(e.getSeconds())},ss:function(e){return ge(e.getSeconds())},S:function(e){return String(Math.round(e.getMilliseconds()/100))},SS:function(e){return ge(Math.round(e.getMilliseconds()/10),2)},SSS:function(e){return ge(e.getMilliseconds(),3)},a:function(e,t){return e.getHours()<12?t.amPm[0]:t.amPm[1]},A:function(e,t){return e.getHours()<12?t.amPm[0].toUpperCase():t.amPm[1].toUpperCase()},ZZ:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+ge(100*Math.floor(Math.abs(t)/60)+Math.abs(t)%60,4)},Z:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+ge(Math.floor(Math.abs(t)/60),2)+":"+ge(Math.abs(t)%60,2)}},me=function(e){return+e-1},fe=[null,"[1-9]\\d?"],ve=[null,ne],ye=["isPm",ne,function(e,t){var i=e.toLowerCase();return i===t.amPm[0]?0:i===t.amPm[1]?1:null}],we=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(e){var t=(e+"").match(/([+-]|\d\d)/gi);if(t){var i=60*+t[1]+parseInt(t[2],10);return"+"===t[0]?i:-i}return 0}],be=(ae("monthNamesShort"),ae("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var Se=function(e,t,i){if(void 0===t&&(t=be.default),void 0===i&&(i={}),"number"==typeof e&&(e=new Date(e)),"[object Date]"!==Object.prototype.toString.call(e)||isNaN(e.getTime()))throw new Error("Invalid Date pass to format");var s=[];t=(t=be[t]||t).replace(oe,(function(e,t){return s.push(t),"@@@"}));var n=ce(ce({},ue),i);return(t=t.replace(se,(function(t){return _e[t](e,n)}))).replace(/@@@/g,(function(){return s.shift()}))},xe=(function(){try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}}(),function(e,t,i,s){s=s||{},i=null==i?{}:i;var n=new Event(t,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,e.dispatchEvent(n),n});const Ce=e=>{let t=[];function i(i,s){e=s?i:Object.assign(Object.assign({},e),i);let n=t;for(let t=0;t<n.length;t++)n[t](e)}return{get state(){return e},action(t){function s(e){i(e,!1)}return function(){let i=[e];for(let e=0;e<arguments.length;e++)i.push(arguments[e]);let n=t.apply(this,i);if(null!=n)return n instanceof Promise?n.then(s):s(n)}},setState:i,subscribe:e=>(t.push(e),()=>{!function(e){let i=[];for(let s=0;s<t.length;s++)t[s]===e?e=null:i.push(t[s]);t=i}(e)})}},$e=(e,t,i,s)=>{if(e[t])return e[t];let n,o=0,r=Ce();const a=()=>i(e).then(e=>r.setState(e,!0)),c=()=>a().catch(t=>{if(e.connected)throw t});return e[t]={get state(){return r.state},refresh:a,subscribe(t){o++,1===o&&(s&&(n=s(e,r)),e.addEventListener("ready",c),c());const i=r.subscribe(t);return void 0!==r.state&&setTimeout(()=>t(r.state),0),()=>{i(),o--,o||(n&&n.then(e=>{e()}),e.removeEventListener("ready",a))}}},e[t]},Pe=e=>e.sendMessagePromise({type:"get_states"});function ke(e,t){if(void 0===e)return null;const{domain:i,service:s}=t.data;return{[i]:Object.assign({},e[i],{[s]:{description:"",fields:{}}})}}function Me(e,t){if(void 0===e)return null;const{domain:i,service:s}=t.data,n=e[i];if(!n||!(s in n))return null;const o={};return Object.keys(n).forEach(e=>{e!==s&&(o[e]=n[e])}),{[i]:o}}const Ne=e=>e.sendMessagePromise({type:"get_services"}),Te=(e,t)=>Promise.all([e.subscribeEvents(t.action(ke),"service_registered"),e.subscribeEvents(t.action(Me),"service_removed")]).then(e=>()=>e.forEach(e=>e()));async function Ve(e){const t=await Pe(e),i={};for(let e=0;e<t.length;e++){const s=t[e];i[s.entity_id]=s}return i}const ze=(e,t)=>e.subscribeEvents(e=>function(e,t){const i=e.state;if(void 0===i)return;const{entity_id:s,new_state:n}=t.data;if(n)e.setState({[n.entity_id]:n});else{const t=Object.assign({},i);delete t[s],e.setState(t,!0)}}(t,e),"state_changed"),Oe=(e,t)=>(e=>$e(e,"_ent",Ve,ze))(e).subscribe(t);var Ae={version:"Version",description:"A custom card for displaying Spotify-Playlist and starting playback",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_missing_spotcast:"Spotcast integration has to be installed for this component to work",show_missing_spotify:"Spotify integration has to be installed for playback information",choose_player:"Choose player"},De={general:"General",general_description:"General settings for this card",appearance:"Appearance",appearance_description:"Customize the style, icon, etc",advanced:"Advanced",advanced_description:"Customize advanced settings",hide_warning:"Hide warnings",playlist_type:"Playlist Type",limit:"Amount of playlists shown",height:"Height of card",country_code:"Country Code for featured playlists",always_play_random_song:"Always play random song when starting playback",title:"Title of card",display_style:"Display Style",grid_cover_size:"Cover size in Grid-View in pixels",grid_center_covers:"Center the covers in Grid-View",account:"Account",filter_out_cast_devices:"Filter out chromecast devices"},Ee={common:Ae,settings:De},Ue={version:"Version",description:"Eine Karte um Spotify-Playlist anzuzeigen und abzuspielen",invalid_configuration:"Ungültige Konfiguration",show_warning:"Warnung",show_missing_spotcast:"Die Spotcast-Integration muss installiert sein, damit diese Karte funktioniert",show_missing_spotify:"Die Spotify-Integration muss installiert sein, damit der Spotify-Status angezeigt werden kann"},je={general:"Generell",general_description:"Generelle Einstellungen",appearance:"Aussehen",appearance_description:"Passe den Stil und anderes an",hide_warning:"Verstecke Warnhinweise",playlist_type:"Playlist Typ",limit:"Anzahl an angezeigten Playlisten",height:"Höhe der Karte",country_code:"Länder-Code für die Featured-Playlist",always_play_random_song:"Spiele immer einen zufälligen Song beim Starten der Wiedergabe ab",title:"Titel der Karte",display_style:"Anzeige-Stil",grid_cover_size:"Cover Größe in der Karten-Ansicht in Pixeln",grid_center_covers:"Zentriere die Cover in der Karten-Ansicht"},He={common:Ue,settings:je},Ye={version:"Version",description:"A custom card for displaying Spotify-Playlist and starting playback",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_missing_spotcast:"Spotcast integration has to be installed for this component to work",show_missing_spotify:"Spotify integration has to be installed for playback information"},Re={general:"General",general_description:"General settings for this card",appearance:"Appearance",appearance_description:"Customize the style, icon, etc",hide_warning:"Hide warnings",playlist_type:"Playlist Type",limit:"Amount of playlists shown",height:"Height of card",country_code:"Country Code for featured playlists",always_play_random_song:"Always play random song when starting playback",title:"Title of card",display_style:"Display Style",grid_cover_size:"Cover size in Grid-View in pixels",grid_center_covers:"Center the covers in Grid-View"},qe={common:Ye,settings:Re};const Le={en:Object.freeze({__proto__:null,common:Ae,settings:De,default:Ee}),de:Object.freeze({__proto__:null,common:Ue,settings:je,default:He}),se:Object.freeze({__proto__:null,common:Ye,settings:Re,default:qe})};function Fe(e,t="",i=""){const s=e.split(".")[0],n=e.split(".")[1],o=(localStorage.getItem("selectedLanguage")||navigator.language.split("-")[0]||"en").replace(/['"]+/g,"").replace("-","_");let r;try{r=Le[o][s][n]}catch(e){r=Le.en[s][n]}return void 0===r&&(r=Le.en[s][n]),""!==t&&""!==i&&(r=r.replace(t,i)),r}const We={general:{icon:"tune",name:Fe("settings.general"),secondary:Fe("settings.general_description"),show:!0},appearance:{icon:"palette",name:Fe("settings.appearance"),secondary:Fe("settings.appearance_description"),show:!1},advanced:{icon:"pencil",name:Fe("settings.advanced"),secondary:Fe("settings.advanced_description"),show:!1}},Ie=["Default","featured","discover-weekly"],Ge=["List","Grid"];let Be=class extends ie{constructor(){super(...arguments),this.accounts=[],this.hidden_cast_devices=[],this.chromecast_devices=[]}async connectedCallback(){super.connectedCallback();const e=await this.hass.callWS({type:"spotcast/accounts"});this.accounts=e;const t=await this.hass.callWS({type:"spotcast/castdevices"});this.chromecast_devices=t.map(e=>e.friendly_name),this.requestUpdate()}setConfig(e){this._config=e}get _name(){return this._config&&this._config.name||""}get _account(){return this._config?this._config._account||"default":""}get _country_code(){return this._config&&this._config.country_code||""}get _limit(){return this._config&&this._config.limit||10}get _playlist_type(){return this._config?this._config.playlist_type||"Default":""}get _always_play_random_song(){return this._config&&this._config.always_play_random_song||!1}get _height(){return this._config&&this._config.height||""}get _display_style(){return this._config&&this._config.display_style||"List"}get _grid_cover_size(){return this._config&&this._config.grid_cover_size||100}get _grid_center_covers(){return this._config&&this._config.grid_center_covers||!1}get _hidden_cast_devices(){return this._config&&this._config.hidden_cast_devices||[]}get _hide_warning(){return this._config&&this._config.hide_warning||!1}get _show_warning(){return this._config&&this._config.show_warning||!1}get _show_error(){return this._config&&this._config.show_error||!1}renderGeneral(){return E`
      <div class="values">
        <div>
          ...
          >
            <paper-listbox slot="dropdown-content" .selected=${this.accounts.indexOf(this._account)}>
              ${this.accounts.map(e=>E` <paper-item>${e}</paper-item> `)}
            </paper-listbox>
          </paper-dropdown-menu>
        </div>
        <div>
          ...
          >
            <paper-listbox slot="dropdown-content" .selected=${Ie.indexOf(this._playlist_type)}>
              ${Ie.map(e=>E` <paper-item>${e}</paper-item> `)}
            </paper-listbox>
          </paper-dropdown-menu>
        </div>
        <div>
        ...
        <div>
          <div>${Fe("settings.always_play_random_song")}</div>
          <ha-switch
      ...
      <div class="values">
        <div>
          <ha-switch
            ...
            @change=${this._valueChanged}
            >${Fe("settings.hide_warning")}</ha-switch
          >
        </div>
        <div>
          <paper-input
        ...
        <div>
          ...
          >
            <paper-listbox slot="dropdown-content" .selected=${Ge.indexOf(this._display_style)}>
              ${Ge.map(e=>E` <paper-item>${e}</paper-item> `)}
            </paper-listbox>
          </paper-dropdown-menu>
        </div>
        <div>
          <div>${Fe("settings.grid_cover_size")}</div>
          <paper-slider
        ...
        <div>
          <div>${Fe("settings.grid_center_covers")}</div>
          <ha-switch
    ...
    `}renderAdvanced(){return E`
      <div class="values">
        <div class="filter_grid">
          <div class="filter_grid--title">${Fe("settings.filter_out_cast_devices")}</div>
          ${this.chromecast_devices.map((e,t)=>E`
              <paper-checkbox
                .idx=${t}
    ...
    `}};e([J({type:Object})],Be.prototype,"hass",void 0),e([Z()],Be.prototype,"_config",void 0),e([Z()],Be.prototype,"_toggle",void 0),Be=e([G("spotify-card-editor")],Be);class Je{constructor(e){this.playlists=[],this.devices=[],this.chromecast_devices=[],this.state_ttl=2e3,this.last_state_update_time=0,this.loading=!1,this.parent=e}is_loading(){return setTimeout(this.set_loading_off,100),this.loading}set_loading_off(){this.loading=!1}is_loaded(){return void 0!==this.playlists.length}getPlaybackOptions(e){return{uri:e,force_playback:"playing"==this.parent.getSpotifyEntityState(),random_song:this.parent.config.always_play_random_song||!1,account:this.parent.config.account}}playUri(e){const t=this.getCurrentPlayer();t?this.playUriOnConnectDevice(t.id,e):console.error("No active device")}transferPlaybackToCastDevice(e){this.parent.hass.callService("spotcast","start",{device_name:e,force_playback:!0,account:this.parent.config.account})}transferPlaybackToConnectDevice(e){this.parent.hass.callService("spotcast","start",{spotify_device_id:e,force_playback:!0,account:this.parent.config.account})}playUriOnCastDevice(e,t){const i=Object.assign(Object.assign({},this.getPlaybackOptions(t)),{device_name:e});this.parent.hass.callService("spotcast","start",i)}playUriOnConnectDevice(e,t){const i=Object.assign(Object.assign({},this.getPlaybackOptions(t)),{spotify_device_id:e});this.parent.hass.callService("spotcast","start",i)}async updateState(){if((new Date).getTime()-this.last_state_update_time<this.state_ttl)console.log("cache is still valid:",this.last_state_update_time);else{console.log("cache is NOT valid:",this.last_state_update_time);try{await this.fetchDevices(),await this.fetchPlayer(),await this.fetchChromecasts(),this.last_state_update_time=(new Date).getTime()}catch(e){console.error("updateState error:",e)}}}getCurrentPlayer(){var e;return null===(e=this.player)||void 0===e?void 0:e.device}async fetchPlayer(){console.log("fetchPlayer");const e={type:"spotcast/player",account:this.parent.config.account};try{this.player=await this.parent.hass.callWS(e)}catch(e){console.log("Failed to fetch plaayer",e)}}async fetchDevices(){console.log("fetchDevices");const e={type:"spotcast/devices",account:this.parent.config.account},t=await this.parent.hass.callWS(e);this.devices=t.devices}async fetchChromecasts(){console.log("fetchChromecasts2:",this.chromecast_devices);try{this.chromecast_devices=await this.parent.hass.callWS({type:"spotcast/castdevices"}),console.log("fetchChromecasts2:",this.chromecast_devices)}catch(e){console.log("Failed to fetch cast devices",e),this.chromecast_devices=[]}}async fetchPlaylists(){this.loading=!0;const e={type:"spotcast/playlists",playlist_type:this.parent.config.playlist_type||"",account:this.parent.config.account,limit:this.parent.config.limit};this.parent.config.country_code&&(e.country_code=this.parent.config.country_code);const t=await this.parent.hass.callWS(e);this.playlists=t.items}}var Ze;console.info(`%c  SPOTIFY-CARD \n%c  ${Fe("common.version")} 2.0.0-beta.15    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"spotify-card",name:"Spotify Card",description:Fe("common.description"),preview:!0});let Ke=Ze=class extends ie{constructor(){super(...arguments),this.spotcast_installed=!1,this.spotify_installed=!1,this.fetch_time_out=0}static async getConfigElement(){return document.createElement("spotify-card-editor")}static getStubConfig(){return{}}connectedCallback(){var e;super.connectedCallback(),this.spotcast_connector=new Je(this),void 0!==(e=this.hass.connection,$e(e,"_srv",Ne,Te)).state.spotcast&&(this.spotcast_installed=!0),Oe(this.hass.connection,e=>this.entitiesUpdated(e))}entitiesUpdated(e){let t=!1;for(const i in e)i.startsWith("media_player")&&(i.startsWith("media_player.spotify_")&&(this.spotify_installed=!0,this.spotify_state=e[i]),t=!0);t&&!document.hidden&&(this.fetch_time_out&&clearTimeout(this.fetch_time_out),this.fetch_time_out=setTimeout(()=>{this.spotcast_connector.updateState().then(()=>{console.log("State updated:",(new Date).toISOString()),this.requestUpdate()})},500))}getSpotifyEntityState(){return this.spotify_state?this.spotify_state.state:""}setConfig(e){let t="";if(e.limit&&"number"!=typeof e.limit&&(t="limit"),e.playlist_type&&!Ie.includes(e.playlist_type)&&(t="playlist_type"),e.country_code&&"string"!=typeof e.country_code&&(t="country_code"),e.height&&"number"!=typeof e.height&&(t="height"),e.display_style&&!Ge.includes(e.display_style)&&(t="display_style"),e.darkmode&&"boolean"!=typeof e.darkmode&&(t="darkmode"),e.show_error||""!=t)throw new Error(Fe("common.invalid_configuration")+": "+t);e.test_gui&&function(){var e=document.querySelector("home-assistant");if(e=(e=(e=(e=(e=(e=(e=(e=e&&e.shadowRoot)&&e.querySelector("home-assistant-main"))&&e.shadowRoot)&&e.querySelector("app-drawer-layout partial-panel-resolver"))&&e.shadowRoot||e)&&e.querySelector("ha-panel-lovelace"))&&e.shadowRoot)&&e.querySelector("hui-root")){var t=e.lovelace;return t.current_view=e.___curView,t}return null}().setEditMode(!0),this.config=Object.assign({},e)}spotifyDeviceSelected(e){if(this.spotcast_connector.getCurrentPlayer())return this.spotcast_connector.transferPlaybackToConnectDevice(e.id);const t=this.spotcast_connector.playlists[0];console.log("spotifyDeviceSelected playing first playlist"),this.spotcast_connector.playUriOnConnectDevice(e.id,t.uri)}chromecastDeviceSelected(e){if(this.spotcast_connector.getCurrentPlayer())return this.spotcast_connector.transferPlaybackToCastDevice(e.friendly_name);const t=this.spotcast_connector.playlists[0];console.log("chromecastDeviceSelected playing first playlist"),this.spotcast_connector.playUriOnCastDevice(e.friendly_name,t.uri)}onShuffleSelect(){var e;console.log("shuffle;",this.spotify_state),"playing"==(null===(e=this.spotify_state)||void 0===e?void 0:e.state)&&this.hass.callService("media_player","shuffle_set",{entity_id:this.spotify_state.entity_id,shuffle:!0})}handlePlayPauseEvent(e,t){e.stopPropagation(),this.spotify_state&&this.hass.callService("media_player",t,{entity_id:this.spotify_state.entity_id})}onPauseSelect(e){this.handlePlayPauseEvent(e,"media_pause")}onResumeSelect(e){this.handlePlayPauseEvent(e,"media_play")}render(){var e,t;let i=E``;this.config.show_warning&&(i=this.showWarning(Fe("common.show_warning"))),this.spotcast_installed||(i=this.showWarning(Fe("common.show_missing_spotcast"))),this.spotify_installed||(i=this.showWarning(Fe("common.show_missing_spotify")));let s=E`<div>Loading...</div>`;!this.spotcast_connector.is_loading()&&this.spotcast_installed?this.spotcast_connector.fetchPlaylists().then(()=>{this.requestUpdate()}):s="Grid"==this.config.display_style?this.generateGridView():this.generateListView();const n=this.spotcast_connector.getCurrentPlayer(),o=null!==(e=null==n?void 0:n.name)&&void 0!==e?e:Fe("common.choose_player");return E`
      <ha-card tabindex="0" style="${this.config.height?`height: ${this.config.height}px`:""}"
        ...
        <div id="header">
          ...
          ${this.config.name?E`<div id="header_name">${this.config.name}</div>`:""}
          <div></div>
        </div>
        <div id="content">
          ${s}
        ...
        <div id="footer">
          ...
          <div class="footer__right">
            ${"playing"==(null===(t=this.spotify_state)||void 0===t?void 0:t.state)?E`<div class="icon playing" @click=${this.onShuffleSelect}>
    ...
    `}generateDeviceList(){var e;const t=null!==(e=this.config.hidden_cast_devices)&&void 0!==e?e:[];return E`
      <div class="dropdown-content">
        <p>Spotify Connect devices</p>
        ${this.spotcast_connector.devices.map(e=>E` <a @click=${()=>this.spotifyDeviceSelected(e)}>${e.name}</a> `)}
        ${this.spotcast_connector.chromecast_devices.length?E`<p>Chromecast devices</p>`:null}
        ${this.spotcast_connector.chromecast_devices.map(e=>t.includes(e.friendly_name)?null:E`<a @click=${()=>this.chromecastDeviceSelected(e)}>${e.friendly_name}</a>`)}
      </div>
    `}generateButtonForCurrent(){var e;return"playing"==(null===(e=this.spotify_state)||void 0===e?void 0:e.state)?E`<div class="icon playing" @click=${this.onPauseSelect}>
        <svg width="24" height="24" viewBox="0 0 500 1000">
          <path d="M0 832h192V192H0V832zM320 192v640h192V192H320z" />
        </svg>
      </div>`:E`<div class="icon playing" @click=${this.onResumeSelect}>
        <svg width="24" height="24">
          <path d="M0 0h24v24H0z" fill="none" />
          <path d="M8 5v14l11-7z" />
        </svg>
      </div>`}generateListView(){var e;if(this.spotcast_connector.is_loaded()){const t=[];for(let i=0;i<this.spotcast_connector.playlists.length;i++){const s=this.spotcast_connector.playlists[i],n=(null===(e=this.spotify_state)||void 0===e?void 0:e.attributes.media_playlist)===s.name;t.push(E`<div class="list-item" @click=${()=>this.spotcast_connector.playUri(s.uri)}>
          <img src="${s.images[s.images.length-1].url}" />

          ${n?this.generateButtonForCurrent():E`<div class="icon">
                <svg width="24" height="24">
                  <path d="M0 0h24v24H0z" fill="none" />
                  <path d="M8 5v14l11-7z" />
                </svg>
          ...
          <p>${s.name}</p>
        </div>`)}return E`<div>${t}</div>`}return E``}generateGridIconForCurrent(){var e;return"playing"==(null===(e=this.spotify_state)||void 0===e?void 0:e.state)?E` <svg width="24" height="24" viewBox="0 0 500 1000" @click=${this.onPauseSelect}>
        <path d="M0 832h192V192H0V832zM320 192v640h192V192H320z" />
      </svg>`:E` <svg width="24" height="24" @click=${this.onResumeSelect}>
        <path d="M0 0h24v24H0z" fill="none" />
        <path d="M8 5v14l11-7z" />
      </svg>`}generateGridView(){var e,t;if(this.spotcast_connector.is_loaded()){const i=[];for(let s=0;s<this.spotcast_connector.playlists.length;s++){const n=this.spotcast_connector.playlists[s],o=(null===(e=this.spotify_state)||void 0===e?void 0:e.attributes.media_playlist)===n.name;null===(t=this.spotify_state)||void 0===t||t.attributes.media_playlist,n.name,i.push(E`<div
        ...
        >
          ...
          <div class="grid-item-overlay-icon">
            ${o?this.generateGridIconForCurrent():E`
      ...
      >
        ${i}
      </div>`}return E``}showWarning(e){return E`<hui-warning>${e}</hui-warning>`}static get styles(){return[Ze.generalStyles,Ze.listStyles,Ze.gridStyles]}};Ke.generalStyles=ee`
    *:focus {
      outline: none;
    }
  ...
  `,e([J({type:Object})],Ke.prototype,"hass",void 0),e([J({type:Object})],Ke.prototype,"config",void 0),e([Z()],Ke.prototype,"spotcast_connector",void 0),Ke=Ze=e([G("spotify-card")],Ke);export{Ke as SpotifyCard};
