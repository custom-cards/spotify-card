 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,n){const s=t[0];if("."===s){return new M(e,t.slice(1),i).parts}if("@"===s)return[new T(e,t.slice(1),n.eventContext)];if("?"===s)return[new k(e,t.slice(1),i)];return new x(e,t,i).parts}handleTextExpression(e){return new $(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
